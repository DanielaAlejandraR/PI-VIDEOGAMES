...
const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/videogames`, { //conexión con BD
  logging: false, // set to console.log to see the raw SQL queries // para que no llene consola de cosas
